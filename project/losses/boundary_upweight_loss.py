"""Boundary-upweighted semantic + Focal MSE aux on support (CR-I).
...
Two mechanisms, different roles:
  ...
  - Focal MSE aux: identical to CR-H.  Focal MSE provides stable
    ...
    term (~0.55 non-decaying) and starved semantic optimization.
"""
...
class BoundaryUpweightLoss(nn.Module):
    """Support-weighted semantic CE + Lovasz + Focal MSE aux."""
    ...
    def forward(
        ...
        **_extra,
        ...
        # === Term 2: Focal MSE on support (from CR-H) ===
