"""Smoke-only training config for semantic + support-only ablation."""
...
weight = None
resume = False
work_dir = str(repo_root / "outputs" / "semantic_boundary_support_only_train_smoke")
