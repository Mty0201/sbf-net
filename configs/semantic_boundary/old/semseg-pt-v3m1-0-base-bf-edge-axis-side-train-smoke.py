"""Smoke config for axis+side direction decomposition.

Verifies that AxisSideSemanticBoundaryLoss produces valid loss values.
"""
# ======================================================================
...
weight = None
resume = False
work_dir = str(repo_root / "outputs" / "semantic_boundary_axis_side_train_smoke")
