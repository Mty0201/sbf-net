"""B-prime training config: Stage-2 v2 model + support-weighted direction/distance.

Identical to Stage-2 v2 train config except:
  - loss: support_weighted_edge=True (direction and distance losses weighted by
    support_gt * valid_gt instead of equal-weight over the full valid domain).

This is the D1-O0 experiment: corrected supervision domain, no explicit basin
organization, no support_id, no coherence.
"""
# ======================================================================
...
weight = None
resume = False
work_dir = str(repo_root / "outputs" / "semantic_boundary_stage2_bprime_train")
