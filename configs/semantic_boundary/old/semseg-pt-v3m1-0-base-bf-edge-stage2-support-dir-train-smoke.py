"""Smoke-only training config for stage-2 support-conditioned direction checks."""
# ======================================================================
...
weight = None
resume = False
work_dir = str(repo_root / "outputs" / "semantic_boundary_stage2_support_dir_train_smoke")
