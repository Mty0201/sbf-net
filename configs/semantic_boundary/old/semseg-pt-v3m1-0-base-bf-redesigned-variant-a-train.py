"""Variant A: SmoothL1+Tversky support + Lovasz-on-boundary focus.

Only run if Variant C achieves val_mIoU >= 0.74 (per D-08). Adds boundary-subset
Lovasz as an orthogonal focus signal to improve boundary-region semantic quality.
"""
# ======================================================================
...
model = runpy.run_path(
    str(repo_root / "configs" / "semantic_boundary" / "old" / "semseg-pt-v3m1-0-base-bf-support-guided-semantic-focus-model.py")
)["model"]
