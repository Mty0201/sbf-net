"""ZAHA exp 3: SBF-net v1 — decoupler + s_weight CE weighting, v1 only.
...
model = runpy.run_path(str(_dir / "zaha_decoupled_v1_model.py"))["model"]
...
weight = None
resume = False
work_dir = str(repo_root / "outputs" / "zaha_lofg2_s38873367" / "sbfnet_v1")
