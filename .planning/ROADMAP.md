...
**Status after CR-L ep100:** CR-L did not clear the bar — best 0.7251 is −0.85pp below CR-A, within single-seed noise. The aux-head single-stream route is effectively exhausted. Remaining open questions: (a) does CR-M's dual-stream architecture close the gap? (b) does CR-P's faithful BFANet (dual-stream + PureBFANetLoss + r=0.06) close it? (c) does CR-O's pure soft-weighted CE (no aux head at all) beat CR-A? The milestone verdict depends on CR-M, CR-N, CR-O, CR-P results.
...
**Depends on:** Phase 5 CR-M / CR-N / CR-O / CR-P training results. CR-L ep100 landed 2026-04-11 (best 0.7251 @ ep68, −0.85pp vs CR-A, within noise). CR-H closed as failed; CR-J dropped; CR-K retained as optional ablation. Post-training test hook separately broken and deferred — blocks test-split numbers but not the training-metric verdict.
