...
- [ ] **REF-02**: Implement per-stage configuration system that supports density-adaptive parameter injection
- [ ] **REF-03**: Add intermediate validation hooks so each stage's output can be verified before feeding the next
- [ ] **REF-04**: Verify behavioral equivalence — refactored pipeline produces identical output for identical inputs under default parameters

## NET-01: Density-Adaptive Supervision (Phase 3)
...
## NET-02: Single-Side Boundary Recovery (Phase 4)
...
## NET-03: Support Element Smoothing (Phase 5)
