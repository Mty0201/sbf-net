...
- 当前阶段主线任务: 以 `semantic val_mIoU` 为核心门槛，完成 `2.5` 阶段文档收束，并为 `Stage-2 architecture improvement phase` 做准备。
- 当前最佳已确认路径: `support only, reg=1, cover=0.2 -> mIoU 74.5`；`reg=1, cover=0.25 -> mIoU 74.4` 可作为次优且稳定参考。
