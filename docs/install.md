...
Dataset format details are in [data_format.md](./data_format.md).
...
The current goal is a clear, reproducible trainable repository layout for stage-1 development.
