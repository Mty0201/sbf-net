...
- **Global scope**: `/home/mty0201/Pointcept/semantic-boundary-field/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/mty0201/Pointcept/semantic-boundary-field/.claude/notes/`)
...
2. Glob `/home/mty0201/Pointcept/semantic-boundary-field/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/mty0201/Pointcept/semantic-boundary-field/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/mty0201/Pointcept/semantic-boundary-field/.claude/notes/` — works in any directory
