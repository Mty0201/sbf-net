...
Use template from `/home/mty0201/Pointcept/semantic-boundary-field/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/mty0201/Pointcept/semantic-boundary-field/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/mty0201/Pointcept/semantic-boundary-field/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
